...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--gen_scale',
                                 type=bool,
                                 default=True,
        ...
        self.parser.add_argument('--trainval',
                                 ...
                                 help='include validation in training and '
                                      'test on test set')
        # add test dataset
        self.parser.add_argument('--add_test_dataset',
                                 action='store_true',
                                 help='include validation in training and '
                                      'test on test set')
        # plot loss curves
        ...
        self.parser.add_argument('--car_heavy_test', default=False, help='car heavy test')

        self.parser.add_argument('--car_high1_test', default=False, help='car high1 test')

        self.parser.add_argument('--car_high2_test', default=False, help='car high2 test')

        self.parser.add_argument('--car_light_test', default=False, help='car light test')

        self.parser.add_argument('--car_all_test', default=False, help='car all test')

        self.parser.add_argument('--car_test', default=False, help='car det test')
        self.parser.add_argument('--cattle_test', default=False, help='cattle test')
        self.parser.add_argument('--test_1_9', default=False, help='test_1_9 ')
        self.parser.add_argument('--test_2_8', default=False, help='test_2_8 ')
        self.parser.add_argument('--test_3_7', default=False, help='test_3_7 ')
        self.parser.add_argument('--test_4_6', default=False, help='test_4_6 ')
        self.parser.add_argument('--test_5_5', default=False, help='test_5_5 ')
        self.parser.add_argument('--test_6_4', default=False, help='test_6_4 ')
        self.parser.add_argument('--test_7_3', default=False, help='test_7_3 ')
        self.parser.add_argument('--test_8_2', default=False, help='test_8_2 ')
        self.parser.add_argument('--test_9_1', default=False, help='test_9_1 ')
        ...
        # 输入的image目录
        self.parser.add_argument('--input_img',
                                 type=str,
